  ...
  return (
    <>
      ...
      <p className="lab_discourse">Discourse</p>
        ...
        <input id="sentences" name="sentences" type="text" value={ sentences }  onChange={handleMessageChange} />
        </div>
        <div className="ttab2"><input type='button' name="Save Sentences"  value="Save discourse" disabled={!sentences} onClick={getData} /></div>
